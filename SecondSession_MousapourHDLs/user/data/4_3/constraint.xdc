...
#======================== LED ========================#
set_property IOSTANDARD LVCMOS33 [get_ports {sgn}]
set_property IOSTANDARD LVCMOS33 [get_ports {overflow}]
set_property PACKAGE_PIN N15 [get_ports {sgn}]
set_property PACKAGE_PIN G18 [get_ports {overflow}]


#======================== Push Button ========================#
set_property IOSTANDARD LVCMOS33 [get_ports {op}]
set_property PACKAGE_PIN J20 [get_ports {op}]
